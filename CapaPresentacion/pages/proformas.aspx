<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="proformas.aspx.cs" Inherits="CapaPresentacion.pages.proformas" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="main" runat="server">
      ...
      <div class="main">
        <form id="form1" runat="server">
            ...
            <asp:PlaceHolder ID="place_edit_proforma" runat="server" Visible="false">
            ...
            <asp:PlaceHolder ID="place_dgv" runat="server">
                 <div class='pure-u-1-2'>
                             <asp:Button ID="btn_add_proforma" runat="server" Text="Crear Proforma" OnClick="btn_add_ven"  class='button-success pure-button' />
                </div>
                <br /> <br />
